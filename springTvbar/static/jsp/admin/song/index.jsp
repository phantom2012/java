				...
				<div class="span12">
					<div class="widget-box">
						<div class="widget-title">
							...
							<h5>视频列表</h5>
							<div class="buttons">
								<a href="/admin/songNew.action" class="btn btn-mini" title="Icon Title"><i class="icon-plus"></i>新增</a>
							</div>
						</div>
    ...
    <script>
       	$(function(){
			...
			$(":checkbox").click(function(){
				...
				var id = $(this).attr('id');
				if(id=='all'){
					location.href="/admin/songIndex.action";
				} else {
					location.href="/admin/songIndex.action?prjId="+id
				}
			});
       	});
      </script>
