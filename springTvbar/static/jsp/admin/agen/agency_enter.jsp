...
<script type="text/javascript" src="http://res.idol.yystatic.com/agency/??js/jquery/jquery.min.js,js/commons/jquery.ext.select.js,js/commons/arttemplate.js,js/json2.js,js/commons/selectServiceData.js,js/admin/index.js"></script>
<script type="text/javascript">
  var post_url = "http://idol.yy.com/agency/" ;
  var agenService  =  new com.yy.ent.AgenService() ;
  agenService.init() ;  
  agenService.initServiceItem();
</script>
</body>
</html>