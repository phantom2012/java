...
public class QRCodeUtil {
	...
	// 二维码尺寸
	private static final int QRCODE_WIDTH = 156;
	private static final int QRCODE_HEIGHT = 172;
	// LOGO宽度
	...
	private static BufferedImage createImage(String content, String imgPath,
			boolean needCompress, QRCodeConfig qrCodeConfig) throws Exception {
	...
	public static ByteArrayOutputStream encode(String content, String imgPath,  boolean needCompress, QRCodeConfig qrCodeConfig) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void encode(String content, String imgPath, String destPath, QRCodeConfig qrCodeConfig)
			throws Exception {
		QRCodeUtil.encode(content, imgPath, destPath, true, qrCodeConfig);
	}
	 ...
	 * @throws Exception
	 */
	public static File encode(String content, String destPath, QRCodeConfig qrCodeConfig) throws Exception {
		return QRCodeUtil.encode(content, null, destPath, false, qrCodeConfig);
	}
	
	public static ByteArrayOutputStream encode(String content, QRCodeConfig qrCodeConfig) throws Exception {
		return QRCodeUtil.encode(content, null, false, qrCodeConfig);
	}
	...
	public static void main(String[] args) throws Exception {
		String text = "http://m.yy.com/?f=428";
